...
// in kashew/test/view_models/home_viewmodel_test.dart.
...
import 'package:kashew/database/repositories/home_repository.dart' as _i3;
...
class MockHomeRepository extends _i1.Mock implements _i3.HomeRepository {
  ...
  @override
  _i4.Future<double> getTotalMonthlyExpense(int? start, int? end) =>
      (super.noSuchMethod(
            Invocation.method(#getTotalMonthlyExpense, [start, end]),
            returnValue: _i4.Future<double>.value(0.0),
          )
          as _i4.Future<double>);

  @override
  _i4.Future<Map<String, dynamic>?> getTopCategory(int? start, int? end) =>
      (super.noSuchMethod(
            Invocation.method(#getTopCategory, [start, end]),
